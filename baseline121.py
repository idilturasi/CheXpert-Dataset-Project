#Cardiomegaly trial 1: Everything kept the same
...
def main():
    ...
    # Create dataset
    pathology = 'Cardiomegaly' # Replace with pathology
    ...
    torch.save(model.state_dict(), 'model3_cardiomegaly_weights_3.pth')

    print("saved weights to file: model3_cardiomegaly_weights_3.pth")
    ...
    submission_df.to_csv("model3_submission_cardiomegaly_3.csv", index=False)
