...
def main():
    ...
    torch.save(model.state_dict(), 'model3_cardiomegaly_no_crop_weights_3.pth')

    print("saved weights to file: model3_cardiomegaly_no_crop_weights_3.pth")
    ...
    submission_df.to_csv("cardiomegaly_no_crop.csv", index=False)
