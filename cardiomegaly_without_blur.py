#Cardiomegaly trial 2: Without blur
...
def main():
    ...
    torch.save(model.state_dict(), 'model3_cardiomegaly_no_blur_weights_3.pth')

    print("saved weights to file: model3_cardiomegaly_no_blur_weights_3.pth")
    ...
    submission_df.to_csv("cardiomegaly_no_blur.csv", index=False)
