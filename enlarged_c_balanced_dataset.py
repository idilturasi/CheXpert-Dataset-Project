#enlarged_cardiomediastinum trial 2: Balanced dataset
...
def main():
    ...
    torch.save(model.state_dict(), 'model3_enlarged_cardiomediastinum2.pth')

    print("saved weights to file: model3_enlarged_cardiomediastinum2.pth")
    ...
    submission_df.to_csv("enlarged_cardiomediastinum_balanced_dataset.csv", index=False)
