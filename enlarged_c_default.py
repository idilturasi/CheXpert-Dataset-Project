#enlarged_cardiomediastinum trial 1: Default
...
def main():
    ...
    # Create dataset
    pathology = 'Enlarged Cardiomediastinum' # Replace with pathology
    ...
    torch.save(model.state_dict(), 'model3_enlarged_cardiomediastinum1.pth')

    print("saved weights to file: model3_enlarged_cardiomediastinum1.pth")
    ...
    submission_df.to_csv("enlarged_cardiomediastinum_default.csv", index=False)
