#Fractures trial 2: Dataset Change
...
def main():
    ...
    torch.save(model.state_dict(), 'model3_fractures2.pth')

    print("saved weights to file: model3_fractures2.pth")
    ...
    submission_df.to_csv("fractures_dataset_change.csv", index=False)
