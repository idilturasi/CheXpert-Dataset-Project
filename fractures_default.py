...
def main():
    ...
    torch.save(model.state_dict(), 'model3_fractures1.pth')

    print("saved weights to file: model3_fractures1.pth")
    ...
    submission_df.to_csv("fractures_default.csv", index=False)
