#Lung Opcaity trial 2: Aggressive Dataset Balance
...
def main():
    ...
    # Create dataset
    pathology = 'Lung Opacity' # Replace with pathology
    ...
    torch.save(model.state_dict(), 'model3_lung_opacity2.pth')

    print("saved weights to file: model3_lung_opacity2.pth")
    ...
    submission_df.to_csv("lung_opacity_balanced.csv", index=False)
