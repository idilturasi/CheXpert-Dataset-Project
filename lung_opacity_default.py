...
def main():
    ...
    torch.save(model.state_dict(), 'model3_lung_opacity1.pth')

    print("saved weights to file: model3_lung_opacity1.pth")
    ...
    submission_df.to_csv("lung_opacity_default.csv", index=False)
