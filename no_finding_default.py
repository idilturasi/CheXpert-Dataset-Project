...
def main():
    ...
    # Create dataset
    pathology = 'No Finding' # Replace with pathology
    ...
    torch.save(model.state_dict(), 'model3_no_finding1.pth')

    print("saved weights to file: model3_no_finding1.pth")
    ...
    submission_df.to_csv("no_finding_default.csv", index=False)
