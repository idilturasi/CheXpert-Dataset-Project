#Pleural Other trial 2: No crop with same number of points
...
def main():
    ...
    torch.save(model.state_dict(), 'model3_pleural_other2_weights.pth')

    print("saved weights to file: model3_pleural_other2_weights.pth")
    ...
    submission_df.to_csv("pleural_other_no_crop.csv", index=False)
