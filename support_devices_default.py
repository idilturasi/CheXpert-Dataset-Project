#Support Devices trial 1: Everything kept the same without blur with densenet121
...
def main():
    ...
    # Create dataset
    pathology = 'Support Devices' # Replace with pathology
    ...
    torch.save(model.state_dict(), 'model3_support_devices1.pth')

    print("saved weights to file: model3_support_devices1.pth")
    ...
    submission_df.to_csv("support_devices_default.csv", index=False)
